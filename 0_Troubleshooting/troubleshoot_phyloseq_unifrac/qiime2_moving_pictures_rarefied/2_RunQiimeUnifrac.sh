...
wget https://docs.qiime2.org/2019.7/data/tutorials/moving-pictures/core-metrics-results/rarefied_table.qza # Rarefied OTU Table

# Variables
orig_table=rarefied_table.qza
