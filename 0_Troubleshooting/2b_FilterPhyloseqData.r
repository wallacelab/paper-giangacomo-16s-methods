...
load(args$infile)   # Loads phyloseq data into variable 'mydata'
...
plot(sort(sample_sums(filtered)), main="Sample Depths (pre-filter)", xlab="", ylab="Counts")
