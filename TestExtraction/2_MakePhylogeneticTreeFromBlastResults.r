...
# args=parser$parse_args(c("-b","Soils/1g_rep-seqs.blast_results.txt", "Plants/1g_rep-seqs.blast_results.txt", "-t", "/home/jgwall/Projects/0_RawData/Silva_132_release/silva_99_otus.tre",
